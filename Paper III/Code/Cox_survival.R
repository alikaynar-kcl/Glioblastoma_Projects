############# SURVIVAL analysis for TCGA (you can change the project)  ###############
...
infile<- infile_TCGA_N # TCGA TPM gene expression for 144 samples (TP) and clinical information:  'sample_id', 'status', 'survival_time'
...
# save(file="{PATH}/Order_Final_result2.Rdata",Order_Final_result2)
# TPM_cox<-Order_Final_result2
#################################################################################################################################################
### Favorable and Unfavorable gene selection for TCGA
